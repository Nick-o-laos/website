...
const projectsData = [
  ...
  },
  {
    ...
    files: [
      { type: 'pdf', name: 'Supply_Chain_Report.pdf', label: 'PDF' },
    ],
  ...
  },
  {
    ...
    files: [
      { type: 'rmd', name: 'Football_Analytics.Rmd', label: 'R Markdown' },
  ...
  },
  {
    ...
    files: [
      { type: 'pdf', name: 'Car_Rentals_Report.pdf', label: 'PDF' },
      { type: 'rmd', name: 'Car_Rentals.Rmd', label: 'R Markdown' },
    ],
